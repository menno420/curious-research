...
- status: decided
- date: 2026-07-13
- verdict: curious-research runs on the substrate-kit agent workflow.
- why: A repo-resident working agreement, decision ledger, and session
  ...
  kit starts curious-research governed instead of accreting rules ad hoc.
