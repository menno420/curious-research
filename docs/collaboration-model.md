# curious-research — collaboration model
...
- When a doc and a source file disagree: the file on main wins over any doc or chat claim; when a guide contradicts reality, fix the guide in the same PR that noticed
- Staleness review cadence: whenever a guide or idea contradicts what actually happened - fix on sight; no calendar ceremony
