...
⚑ needs-owner: the full checklist lives in docs/eap-closeout-walkthrough-2026-07-14.md §C (6 items, one sitting): branch-deletion ruleset scope check (walkthrough §C item 1, corrected) · optional 37-branch sweep (PR #41 table) · slicer name · drybox **A**/L · arm calibration.json · hand the gift over + collaborator invite.
